...
if __name__ == "__main__":
    ...
    train_dataset = Dataset(args, path='train.txt', vocab=None, random=True, split=True) # 300k
    valid_dataset = Dataset(args, path='val.txt', vocab=None, random=True, split=True) # 33k
    frequent_dataset = Dataset(args, path='most_frequent.txt', vocab=None, random=True, split=True, remove_long_words=True)
